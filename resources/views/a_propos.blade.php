...
<section class="row well">
	...
	<aside class="col-sm-6 col-sm-offset-3" style="text-align: justify; text-align-last: center;font-size: 1.4em;margin-top: 25px">
		<p><strong>ZeCOURSIER</strong> est une auto-entreprenariat, son rôle principal est <strong>le stockage, la livraison à domicile et vous pouvez suivre</strong> l'état de vos colis que ça soit une marchandise, produit, ..., etc.</p>
